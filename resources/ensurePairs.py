"""
Проверява дали json ред съдържа повече от еднa двойка "Въпрос:" и "Отговор:" (възможен дефект при синтетично генерираната база данни). Aко се съдържа принтира проблемния ред
"""
import json
import re
